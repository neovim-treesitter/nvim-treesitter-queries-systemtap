# nvim-treesitter-queries-systemtap

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-systemtap/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-systemtap/actions/workflows/validate.yml)

Neovim tree-sitter queries for **systemtap**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-systemtap",
...
- [ ] Changes are scoped to `systemtap` — do not include files for other languages
